...
const {FUNCTION_NAME, FUNCTION_REGION, GCP_PROJECT, TMP_BUCKET} = process.env;

/**
 * Bucket which should host exported JSON payloads
 * as a midpoint for Terra's pull-based import API.
 */
const stagingBucket = storage.bucket(TMP_BUCKET);
